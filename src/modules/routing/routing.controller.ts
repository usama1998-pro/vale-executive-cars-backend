...
export class RoutingController {
  ...
  @ApiOperation({
    ...
    description:
      'Geocodes pickup/drop-off (and optional via), queries OSRM for driving distance, and returns fares for all vehicle types.',
  })
  @ApiResponse({ status: 400, description: 'Address could not be geocoded or route not found' })
